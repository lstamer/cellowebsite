...
export function WeddingStatsCtaBanner() {
  ...
  useGSAP(
    () => {
      ...
      // Stats fade in
      gsap.from(".wedding-banner-stat", {
        scrollTrigger: {
          trigger: ".wedding-banner-stats-grid",
          start: "top 85%",
          once: true,
        },
        y: 20,
  ...
  return (
    <div ref={containerRef} id="weddings-availability" className="bg-surface-dark relative overflow-hidden border-y border-primary/10 py-20 md:py-24">
