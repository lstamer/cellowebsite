...
export function WeddingHero() {
  ...
  return (
    <section
      ref={containerRef}
      className="sticky top-0 z-[1] relative h-[70svh] lg:h-[70dvh] w-full flex items-end pb-20 md:pb-28 px-section-x-sm md:px-section-x-md lg:px-section-x-lg overflow-hidden bg-surface-dark"
    >
      {/* Background Image */}
